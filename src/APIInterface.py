...
def getHistoricalData(symbol, timeframe, limit, start_date):
    '''
    ...
    '''
    url = Authentication.BASE_URL_MARKETS + "/bars?symbols=" + symbol + "&timeframe=" + timeframe + "&start="+ quote(start_date) +"&limit=" + str(limit)+ "&sort=desc"
    print(url)
